  ...
  return knex('products').del()
    .then(function () {
      return Promise.all([
        ...
        knex('products').insert({id: 5, cate_id: 1, brand_id: 3, name: 'Rouge Pur Couture Satin Radiance Lipstick', colour: 'Taupe Raphael', price: 37, image: '/products/taupe_raphael.png'}),
